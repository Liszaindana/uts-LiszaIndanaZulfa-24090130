...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (loginBtn) {
    ...
    loginBtn.addEventListener('click', function (e) {
      ...
      const email = emailInput ? emailInput.value.trim() : 'lisza@gmail.com';
      const pass = passInput ? passInput.value.trim() : '24090130';
      ...
      if (isEmailEmpty && isPassEmpty) {
        ...
        if (isPassEmpty) {
          ...
          isValid = false;
        } else if (pass !== '24090130') {
          showError(passInput, 'Password salah, NIM: 24090130');
          isValid = false;
        }
      }
